...
<tr><th>ID</th><th>Name</th><th>Email</th><th>Mobile</th><th>Query</th><th>Date</th></tr>
...
include('conn.php');
  ...
  $sql=mysqli_query($conn,"select * from query");
...
<th><?php echo $a['mobile']; ?></th>
<th><?php echo $a['query']; ?></th>
