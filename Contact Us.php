...
<div class="col-md-12" style="background-image:url(p%20images/IMG-20180602-WA0062.jpg);height:700px">

<div class="col-md-4">

<form method="post">
<legend style="color:#000;font-size:36px;text-align:center;font-family:'Arial Black', Gadget, sans-serif;margin-top:50px">Contact Us</legend> 
...
if($a)
  ...
  if(isset($_POST['sub']))  
	...
	$sql=mysqli_query($conn,"insert into query (name,email,mobile,query,Date)values('$nm','$em','$mb','$qu','$dt')");	 
